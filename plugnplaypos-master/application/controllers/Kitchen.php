...
class Kitchen extends Cl_Controller {
    ...
    public function get_all_information_of_a_sale_kitchen_type($sales_id){
        ...
        foreach($items_by_sales_id as $single_item_by_sale_id){
            $tag_information = $this->Kitchen_model->getTagsBySaleAndSaleDetailsId($sales_id,$single_item_by_sale_id->sales_details_id);
    ...
    public function get_new_orders(){
        ...
        for($i;$i<count($data1);$i++){
            ...
            foreach($items_by_sales_id as $single_item_by_sale_id){
                $tag_information = $this->Kitchen_model->getTagsBySaleAndSaleDetailsId($data1[$i]->sale_id,$single_item_by_sale_id->sales_details_id);
                $single_item_by_sale_id->tags = $tag_information;
            }
