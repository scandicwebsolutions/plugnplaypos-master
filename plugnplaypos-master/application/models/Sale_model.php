...
//        }
    ...
    public function getAllMenuTags(){
      $this->db->select("tbl_food_menus_tags.*,tbl_food_tags.title,tbl_food_tags.type");
      $this->db->from("tbl_food_menus_tags");
      $this->db->join('tbl_food_tags', 'tbl_food_tags.id = tbl_food_menus_tags.tag_id', 'left');
      $this->db->order_by('id', 'ASC');
      $result = $this->db->get();   
    ...
    public function getAllMenuTagItems() {
      $this->db->select("*");
     ...
     * added by Liao
     */
    public function getTagsBySaleAndSaleDetailsId($sales_id,$sale_details_id){
      $this->db->select("tbl_sales_details_tags.*,tbl_food_tags.title AS `tag_title`, tbl_food_tags_items.title AS `item_title`");
      $this->db->from('tbl_sales_details_tags');
      $this->db->join('tbl_food_tags', 'tbl_food_tags.id = tbl_sales_details_tags.tag_id', 'left');
      $this->db->join('tbl_food_tags_items', 'tbl_food_tags_items.id = tbl_sales_details_tags.tag_item_id', 'left');
      $this->db->where("tbl_sales_details_tags.sales_id", $sales_id);
      $this->db->where("tbl_sales_details_tags.sales_details_id", $sale_details_id);
      $this->db->order_by('tbl_sales_details_tags.id', 'ASC');
      $result = $this->db->get();   
     ...
     * added by Liao
     */
    public function getTagsByHoldAndHoldsDetailsId($hold_id,$holds_details_id)
    {
      $this->db->select("tbl_holds_details_tags.*,tbl_food_tags.title AS `tag_title`, tbl_food_tags_items.title AS `item_title`");
      $this->db->from('tbl_holds_details_tags');
      $this->db->join('tbl_food_tags', 'tbl_food_tags.id = tbl_holds_details_tags.tag_id', 'left');
      $this->db->join('tbl_food_tags_items', 'tbl_food_tags_items.id = tbl_holds_details_tags.tag_item_id', 'left');
      $this->db->where("tbl_holds_details_tags.sales_id", $hold_id);
      $this->db->where("tbl_holds_details_tags.sales_details_id", $holds_details_id);
      $this->db->order_by('tbl_holds_details_tags.id', 'ASC');
