...
foreach ($food_menus as $single_menus) {
    ...
    //get tags if menu id match with menus tags table
    $tags = '';
    $j = 1;
    foreach ($menu_tags as $single_menu_tag) {
        if ($single_menu_tag->food_menu_id == $single_menus->id) {
            $items = '';
            if ($single_menu_tag->type != 'Text Field') {
                foreach ($menu_tag_items[$single_menu_tag->tag_id] as $item) {
                    $items .= ",{tag_id:'" . $item->tag_id . "',tag_item_id:'" . $item->id . "',tag_item_title:'" . $item->title . "',tag_item_price:'" . $item->price . "'}";                    
                }
                if (strlen($items) > 0) {
            ...
            if ($j == count($menu_tags)) {
                $tags .= "{menu_tag_id:'" . $single_menu_tag->tag_id . "',menu_tag_title:'" . $single_menu_tag->title . "',menu_tag_type:'" . $single_menu_tag->type . "',menu_tag_items:[" . $items . "]}";
            } else {
                $tags .= "{menu_tag_id:'" . $single_menu_tag->tag_id . "',menu_tag_title:'" . $single_menu_tag->title . "',menu_tag_type:'" . $single_menu_tag->type . "',menu_tag_items:[" . $items . "]},";
            }
        }
...
foreach ($customers as $customer) {
    ...
    if($seluser_id==$customer->id) $selected = 'selected'; else $selected="";    
    ...
    if ($customer->name == 'Walk-in Customer') {
        if($seluser_id==0)
            ...
            $customers_option = '<option value="' . $customer->id . '">' . $customer->name . ' ' . $customer->phone . '</option>' . $customers_option;
    } else {
...
foreach ($tables as $table) {
    ...
    $tables_modal .= '<input type="text" name="" placeholder="Person" class="floatleft bottom_person" id="single_table_order_details_bottom_person_' . $table->id . '" value="1">';
...
<head>
    ...
    <!-- card elements -->
    <!-- <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bower_components/card/card.css"> -->
    <script src="<?php echo base_url() ?>assets/bower_components/card/jquery.card.js"></script>

    <script type="text/javascript">
        $(document).ready(function(){
            $('#ipp_manual_form').card({
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/bower_components/wait-me/waitMe.min.css">
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/bower_components/wait-me/waitMe.min.js"></script>
    ...
    <base data-collect-tax="<?php echo $this->session->userdata('collect_tax'); ?>">
    </base>
    <base data-currency="<?php echo $this->session->userdata('currency'); ?>">
    </base>
    <base data-role="<?php echo $this->session->userdata('role'); ?>">
    </base>
    <base data-collect-gst="<?php echo $this->session->userdata('tax_is_gst'); ?>">
    </base>
    <base data-gst-state-code="<?php echo $this->session->userdata('gst_state_code'); ?>">
    </base>
...
<body>
    ...
    <input type="hidden" id="init_tableid" value="<?php echo $seltable_id; ?>">
        ...
        <div class="top_header_part fix">
            ...
            <div class="header_part_right fix">
                ...
                <div style="text-align:center;width:20%;" class="header_single_button_holder">
                    <button id="notification_button"><i class="fas fa-bell"></i> <?php echo "Online Order"; ?> (<span id="notification_counter"><?php echo $notification_number; ?></span>)</button>
                </div>
                ...
                <div class="header_single_button_holder" style="width:18%; ">
                ...
                <div class="holder fix">
                    ...
                    <div style="position: absolute;bottom: 8px;width:100%;" id="left_side_button_holder_absolute">
                        <?php if ($this->session->userdata('pre_or_post_payment') == "Post Payment") { ?>
                            <button class="operation_button fix" id="modify_order"><i class="fas fa-edit"></i> Modify Order<?php //lang('modify_order'); 
                                                                                                                            ?></button>
                        <?php } ?>
            ...
            <div class="main_middle fix">
                <div class="main_top fix">
                    ...
                    <div class="waiter_customer">
                        ...
                        <input type="hidden" id="select_waiter" name="select_waiter" value="<?php echo $waiter_id; ?>"/>
                        <div class="single_button_middle_holder" style="width:66.6%">
                            <!-- <div class="inner3item"> -->
                                <select id="walk_in_customer" class="select2">
    ...
    <!-- The Modal -->
    <div id="item_modal" class="modal" style="padding-top: 50px;">
        ...
        <div class="modal-content" style="width: 600px;">
            ...
            <div style="margin: 0 5px;">
                ...
                <div class="section_t1 fix">
                    <div class="sec_t1_inside" id="sec_t1_1"><?php echo lang('tags'); ?></div>
                    <div class="sec_t1_inside" id="sec_t1_2"><?php echo $this->session->userdata('currency'); ?> <span id="modal_tags_price_variable">0</span><span id="modal_tags_unit_price_variable" style="display: none;">0</span></div>
                </div>
                <div class="section_t2 fix">
    ...
    <div id="finalize_order_modal" class="modal">
        <!-- Modal content -->
        <div class="modal-content" id="modal_finalize_order_details" style="width: 400px;">
            <h1 id="modal_finalize_header"><?php echo lang('finalize_order'); ?></h1>
            
            <div class="fo_2 fix">
                <div class="half fix floatleft"><?php echo 'Payment Method'; //lang('total_payment'); 
                                                ?></div>
            ...
            <div id="finalize_order_ipp_section">
                <div class="fo_3 bottom_buttons fix" style="border-bottom: none;">
                    <?php foreach ($ipp_methods as $im) { ?>
                        <div style="display: inline-block" class="bottom_single_button fix">
                            <button class="finalize_order_button ipp_button" id="finalize_order_button_<?= $im->id ?>" data-id="<?= $im->id ?>">
                                <?= $im->name ?>
                            </button>
                        </div>
                    <?php } ?>
                ...
                <div id="finalize_order_ipp_manual" class="fo_3" style="display:none; border-bottom: none;">
                    <div class='card-wrapper'></div>
                    <form id="ipp_manual_form" style="margin-top: 12px;margin-bottom: 80px;">
                        <div class="half fix floatleft textleft"><?php echo lang('card_number'); ?></div>
                        <div class="half fix floatleft textleft"><?php echo lang('card_holder'); ?></div>
                        <div class="half fix floatleft textleft"><input type="text" name="number" id="ipp_manual_card_num"></div>
                        <div class="half fix floatleft textleft"><input type="text" name="name" id="ipp_manual_card_holder"></div>

                        <div class="half fix floatleft textleft" style="margin-top: 5px;"><?php echo lang('card_expiry'); ?></div>
                        <div class="half fix floatleft textleft" style="margin-top: 5px;"><?php echo lang('card_cvc'); ?></div>
                        <div class="half fix floatleft textleft"><input type="text" name="expiry" id="ipp_manual_card_expiry"></div>
                        <div class="half fix floatleft textleft"><input type="text" name="cvc" id="ipp_manual_card_cvc"></div>
                    </form>
                </div>

                <div id="finalize_order_ipp_emv" class="fo_3" style="display:none; border-bottom: none;">
                    <div class="half fix floatleft">EMV Device List:</div>
                    <div class="half fix floatleft textright">
                        <select name="ipp_emv_list" id="ipp_emv_list">
                            <?php foreach ($emv_device_list as $value) { ?>
                ...
                <div id="finalize_order_ipp_swipe" class="fo_3 textcenter" style="display:none; border-bottom: none;margin-bottom:-40px;">
                    <img class="swipe-overlay" src="<?php echo base_url(); ?>assets/POS/images/swipe.jpg" />
                    <p>Please swipe your card.</p>
                    <input type="text" id="magstripe" style="position:relative; top: -150px; z-index: -100;" />
                </div>

                <div class="bottom_buttons fix" style="border-top: 1px dashed #ced4da;">
                    <div style="display: none;" class="bottom_single_button fix" id="finalize_order_button_ipp_div">
                        <button id="finalize_order_button_ipp" class="finalize_order_button"><?php echo lang('submit'); ?></button>
                    </div>
                    <div style="display: inline-block" class="bottom_single_button fix">
                        <button class="finalize_order_cancel_button finalize_order_button"><?php echo lang('cancel'); ?></button>
                    </div>
                </div>
            </div>

            <div id="finalize_order_cash_section">
                <div class="bottom_buttons fix">
                    <div style="display: inline-block" class="bottom_single_button fix">
                        <button id="finalize_order_button" class="finalize_order_button"><?php echo lang('submit'); ?></button>
                    </div>
                    <div style="display: inline-block" class="bottom_single_button fix">
                        <button class="finalize_order_cancel_button finalize_order_button"><?php echo lang('cancel'); ?></button>
                    </div>
            ...
            <div style="display: none;">
                <input type="hidden" id="selected_ipp_method" />
            </div>

            <div class="fo_3 fix"  style="display: none;">
            ...
            <!-- <div class="bottom_buttons fix">
                ...
                <div style="display: inline-block" class="bottom_single_button fix">
                    <button id="finalize_order_ipp_button"><?php echo lang('ipp_pay'); ?></button>
                </div>
            </div> -->
            <!-- <span class="close">&times;</span> -->
            <!-- <p>Some text in the Modal..</p> -->
    ...
    <div id="notification_list_modal" class="modal">
        ...
        <div class="modal-content" id="modal_notification_list_details">
            ...
            <div id="notification_close_delete_button_holder">
                ...
                <button id="notification_close"><?php echo 'Cancel'; //lang('close'); 
                                                ?></button>
            </div>
        </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/POS/js/custom.js?ver=<?php echo microtime(); ?>"></script>
