        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">  
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" name="will_login" value="<?php echo $user_details->will_login; ?>" />
                    <div id="will_login_section" style="display:<?php if($user_details->will_login=="Yes"){echo "block;";}else{echo "none;";}?>">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label><?php echo lang('pin_code'); ?><span class="required_star"> *</span></label> 
                                    <input tabindex="3" type="password" id="pin_code" name="pin_code" class="form-control" placeholder="<?php echo lang('pin_code'); ?>" value="<?php echo $user_details->pin_code; ?>" onkeypress='validate(event)'>
                                    <span toggle="#pin_code" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                </div>
                                <?php if (form_error('pin_code')) { ?>
                                    <div class="alert alert-error" style="padding: 5px !important;">
                                        <span class="error_paragraph"><?php echo form_error('pin_code'); ?></span>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
