        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">  
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" name="will_login" value="Yes" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input tabindex="3" type="password" id="pin_code" name="pin_code" class="form-control" placeholder="<?php echo lang('pin_code'); ?>" value="<?php echo set_value('pin'); ?>" onkeypress='validate(event)'>
