...
<script>
    ...
    $(function () {
        ...
        var suffix = 
<?php
            if (isset($food_tags_items)) {
                echo count($food_tags_items);
            } else {
                echo 0;
            }
?>;  
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <?php echo form_open(base_url() . 'Master/addEditFoodTag', $arrayName = array('id' => 'food_tags_form')) ?>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><?php echo lang('title'); ?> <span class="required_star">*</span></label>
                                <input tabindex="1" type="text" id="title" name="title" class="form-control" placeholder="<?php echo lang('title'); ?>" value="<?php echo set_value('title'); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="3" type="text" name="description" class="form-control" placeholder="<?php echo lang('description'); ?>" value="<?php echo set_value('description'); ?>">
                            </div>
                        </div>
                    </div>

                    <div class="clearfix"></div>
                    <div id="items_table_container">
