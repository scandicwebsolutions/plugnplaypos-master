                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;width: 10%"><?php echo lang('total_ingredients'); ?></th>
                                <th style="text-align: center;width: 10%"><?php echo lang('tag_count'); ?></th>
                                <th style="width: 14%"><?php echo lang('added_by'); ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($foodMenus as $value) {
                                ...
                                <tr> 
                                    ...
                                    <td style="text-align: center"><?php echo tagsCountByFoodMenu($value->id); ?></td>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu"> 
                                                ...
                                                <li><a href="<?php echo base_url() ?>Master/assignFoodMenuTag/<?php echo $this->custom->encrypt_decrypt($value->id, 'encrypt'); ?>" ><i class="fa fa-plus tiny-icon"></i><?php echo lang('assign_tag'); ?></a></li>
